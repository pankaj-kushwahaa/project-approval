...
<div class="w3-container">
  <div class="w3-section w3-bottombar w3-padding-16">
    ...
    <a href="add-projects.php" class="w3-button w3-black"><i class="fa-solid fa-graduation-cap mx-1"></i> All Approved<?php $sql8 = "SELECT pro_id, COUNT(pro_id) total_pro FROM project_request pr INNER JOIN branch b ON pr.pro_branch_id = b.branch_id
    ...
    ?><a href="add-projects-branch.php?branch_id=<?php echo $row3['branch_id'] ?>" class="w3-button w3-white"><?php echo $row3['branch_name'].' ('.$total_pro.')';; ?></a>

    <?php }} ?>
    <a href="add-post.php" class="w3-button w3-white"><i class="fa fa-diamond w3-margin-right"></i> Add Manually</a>
  </div>
</div>
<!-- Filter section end -->
...
<div class="w3-row pagination">
  <?php
    ...
    if($result2->rowCount()){
      ...
      echo '<ul>';
      if($page > 1){
        echo '<li class="w3-button w3-grey mx-1"><a href="add-projects.php?page='.($page-1).'">Previous</a></li>';
      }
      ...
      for($i = 1; $i <= $total_pages; $i++){
        ...
        echo '<li class="w3-button w3-grey mx-1 '.$active.'"><a href="add-projects.php?page='.$i.'" class="w3-blue" style="padding:100%;">'.$i.'</a></li>';
      }
      if($total_pages > $page){
        echo '<li class="w3-button w3-grey mx-1"><a href="add-projects.php?page='.($page + 1).'">Next</a></li>';
      }
      echo '</ul>';
    }
  ?>
     <!-- <ul>
      <li class="w3-button w3-grey"><a href="#">Previous</a></li>
      
      <li class="w3-button w3-grey"><a href="#">Next</a></li>
    </ul> -->
